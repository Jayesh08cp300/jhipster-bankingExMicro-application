...
class AResourceIT {
    ...
    void createA() throws Exception {
        ...
        assertThat(testA.getAa()).isEqualTo(DEFAULT_AA);
    }
    ...
    void putNewA() throws Exception {
        ...
        A testA = aList.get(aList.size() - 1);
        assertThat(testA.getAa()).isEqualTo(UPDATED_AA);
    }
