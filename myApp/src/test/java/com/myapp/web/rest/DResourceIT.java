...
class DResourceIT {
    ...
    private static final String DEFAULT_DD = "AAAAAAAAAA";
    private static final String UPDATED_DD = "BBBBBBBBBB";
    ...
    void createD() throws Exception {
        ...
        assertThat(testD.getDd()).isEqualTo(DEFAULT_DD);
    }
    ...
    void putNewD() throws Exception {
        ...
        D testD = dList.get(dList.size() - 1);
        assertThat(testD.getDd()).isEqualTo(UPDATED_DD);
    }
