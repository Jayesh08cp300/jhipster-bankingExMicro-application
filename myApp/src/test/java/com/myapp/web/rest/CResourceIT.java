...
class CResourceIT {
    ...
    void createC() throws Exception {
        ...
        assertThat(testC.getCc()).isEqualTo(DEFAULT_CC);
    }
    ...
    void putNewC() throws Exception {
        ...
        C testC = cList.get(cList.size() - 1);
        assertThat(testC.getCc()).isEqualTo(UPDATED_CC);
    }
