...
@RestController
@RequestMapping("/api/banking-ex-micro-kafka")
public class BankingExMicroKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BankingExMicroKafkaResource.class);
    ...
    public BankingExMicroKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
