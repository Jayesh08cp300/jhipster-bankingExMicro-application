...
class BResourceIT {
    ...
    private static final String DEFAULT_BB = "AAAAAAAAAA";
    private static final String UPDATED_BB = "BBBBBBBBBB";
    ...
    void createB() throws Exception {
        ...
        assertThat(testB.getBb()).isEqualTo(DEFAULT_BB);
    }
    ...
    void getAllBS() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.[*].bb").value(hasItem(DEFAULT_BB)));
    }
    ...
    void getB() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.bb").value(DEFAULT_BB));
    }
    ...
    void putNewB() throws Exception {
        ...
        B testB = bList.get(bList.size() - 1);
        assertThat(testB.getBb()).isEqualTo(UPDATED_BB);
    }
